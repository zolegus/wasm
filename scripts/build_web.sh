...
# wasm2wat target/wasm32-unknown-unknown/release/wasm.wasm | rg env
# wasm2wat target/wasm32-unknown-unknown/release/wasm.wasm | rg "call .now\b" -B 20 # What calls `$now` (often a culprit)
